        ...
        URLSession.shared.dataTask(with: url) { data, response, error in
            ...
            do {
                ...
                if let meal = mealData.meals.first {
                    ...
                    if let ingredient1 = meal.strIngredient1, let measure1 = meal.strMeasure1 {
                        print("Ingredients: \(ingredient1) - Amount: \(measure1)")
                    }

                    if let ingredient2 = meal.strIngredient2, let measure2 = meal.strMeasure2 {
                        print("Ingredients: \(ingredient2) - Amount: \(measure2)")
                    }
                    // Assign the fetched meal data to specificMeal
                    DispatchQueue.main.async {
                        self.specificMeal = mealData.meals
                        // Print the contents of specificMeal
                        print("Specific Meal Array Contents: \(self.specificMeal)")
                    }
                } else {
...
struct Meal: Codable {
    ...
    // Define optional properties for ingredients
    ...
    // Define optional properties for measurements
